<div class="footer">
                ...
                <div class="col-md-4">
                    ...
                    <div class="footerContactUs">
                        ...
                        <div class="perFooterContactUs">
                            ...
                            <p class="text-white">000000000000</p>
                        </div>

                        <div class="perFooterContactUs">
                            <i class="fas text-white fa-road"></i>
                            <p class="text-white">xxxxxx xxxxx xxxxx</p>
                        </div>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="search" placeholder="Example@gmail.com"
                                aria-label="Search">
                            <button class="btn btn-primary btn-newsletter" type="submit">Send</button>
                        </div>
    ...
    <div class="footerCopyright">
        <p class="text-white">
            <i class="far fa-copyright"></i>2021 By : <span>Riko Airlan Ramadhan</span>
        </p>
    </div>
